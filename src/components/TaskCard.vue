...
<template>
  <div :class="!task.completed ? 'bg-red hover:bg-red-5' : 'bg-green hover:bg-green-5'" class="h-max w-full flex justify-between rounded-5 shadow-sm text-center text-clip" @click="viewTask">
